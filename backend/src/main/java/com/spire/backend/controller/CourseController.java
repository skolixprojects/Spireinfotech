...
public class CourseController {
    ...
    public ResponseEntity<ApiResponse<CourseDTO>> createCourse(
        ...
        // Post-role-consolidation: TRAINER folded into INSTRUCTOR, so
        // instructors can create either COURSE or SERVICE (formerly
        // trainer-only). Admins still create either.
