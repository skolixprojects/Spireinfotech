      ...
      >
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-3">
          ...
          <button
            ...
            className="w-full py-2.5 rounded-lg bg-[#0F766E] text-white text-sm font-semibold hover:bg-[#0D9488] focus:outline-none focus:ring-2 focus:ring-[#14B8A6] focus:ring-offset-2 transition-colors disabled:opacity-60 disabled:cursor-not-allowed inline-flex items-center justify-center gap-2 cursor-pointer"
          >
