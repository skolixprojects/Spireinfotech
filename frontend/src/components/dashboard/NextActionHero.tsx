...
export function NextActionHero({ action, loading }: NextActionHeroProps) {
  if (loading || !action) {
    return (
      <div className="rounded-2xl bg-gradient-to-br from-[#0E6B6B] to-[#5FA3A3] p-8 sm:p-10 animate-pulse">
  ...
  return (
    <motion.div
      ...
      className="rounded-2xl bg-gradient-to-br from-[#0E6B6B] to-[#5FA3A3] text-white p-8 sm:p-10 shadow-lg shadow-[#0E6B6B]/15"
    >
      {renderBody(action)}
    </motion.div>
  );
