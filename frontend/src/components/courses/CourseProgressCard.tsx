    ...
    >
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          <div className="w-8 h-8 rounded-lg bg-[#0E6B6B]/10 flex items-center justify-center">
            <TrendingUp size={16} className="text-[#0E6B6B]" />
          </div>
          <p className="text-sm font-semibold text-gray-900">Your Progress</p>
        </div>
        <p className="text-2xl font-bold text-[#0E6B6B] tabular-nums">
          {progressPercent}%
        </p>
      </div>
